...
import application.accueil.Parametre;
...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			controller.setDatas(paramsActuels.couperLeSonParDefaut);
	...
	private void creerFichierDesParametres() {
		...
		if (!paramsFile.exists()) {
			try {
				...
				String paramsParDefaut = dossierParDefautDesThemes.getPath() + "|0";
